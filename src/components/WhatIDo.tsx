        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Building scalable and secure web platforms, RESTful APIs, and efficient backends using modern Javascript and Typescript frameworks.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Empowering businesses with Generative AI, chatbots, and optimized cloud architectures using Google Cloud and AWS.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
